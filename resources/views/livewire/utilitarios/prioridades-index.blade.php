    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex space-x-2 justify-between mb-2">
            ...
            <div>
                ...
                @livewire('utilitarios.prioridades-create')
                ...
                <table class="w-full">
                    <thead class="bg-gray-50 border-b-2 border-gray-200">
                        <tr>
                            ...
                            <th class="p-3 text-sm font-semibold tracking-wide text-left">{{ __('Priority') }}</th>
                            ...
                            <tr class="bg-white">
                                ...
                                <td class="p-3 text-sm text-gray-700 whitespace-nowrap">
                                    <span
                                        ...
                                        {{ $prioridad->activo == 1 ? 'Habilitado' : 'Deshabilitado' }}
                                    </span>
                                </td>
                                <td class="p-3 text-sm text-gray-700 whitespace-nowrap">
                ...
                @foreach ($prioridades as $prioridad)
                    <div class="bg-white space-y-3 p-4 rounded-lg shadow">
                        <div class="flex justify-between space-x-2 text-sm">
                            <div>
                                <a href="#" class="text-blue-500 font-bold hover:underline">{{ $prioridad->id }}</a>
                            </div>
    ...
    <x-jet-dialog-modal wire:model="modal_edit">
        ...
        <x-slot name="content">
            <div class="col-span-6 sm:col-span-4">
                <x-jet-label for="nombre" value="{{ __('Priority') }}" />
                <x-jet-input wire:model.defer="prioridad.nombre" type="text" class="mt-1 block w-full"
                    />
                <x-jet-input-error for="prioridad.nombre" class="mt-2" />
            </div>
            <div class="col-span-6 sm:col-span-4 mt-4">
                <x-jet-label for="descripcion" value="{{ __('Description') }}" />
                <x-jet-input wire:model.defer="prioridad.descripcion" type="text" class="mt-1 block w-full"
                    />
                <x-jet-input-error for="prioridad.descripcion" class="mt-2" />
            </div>
