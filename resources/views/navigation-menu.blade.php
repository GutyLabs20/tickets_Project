<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link-parent :href="'#'" :active="request()->routeIs('cliente*')">
                    ...
                    <x-jet-nav-link href="{{ route('tickets.lista') }}" :active="request()->routeIs('tickets')">
                        {{ __('Tickets') }}
                    </x-jet-nav-link>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link-parent :href="'#'" :active="request()->routeIs('cliente*')">
                <x-slot name="name">{{ __('Customers') }}</x-slot>
                <x-slot name="children">
                    <a href="{{ route('cliente.empresas') }}">{{ __('Company') }}</a>
                    <a href="{{ route('cliente.puestos') }}">{{ __('Position') }}</a>
            ...
            <x-jet-responsive-nav-link href="{{ route('tickets.lista') }}" :active="request()->routeIs('tickets')">
                {{ __('Tickets') }}
            </x-jet-responsive-nav-link>
        </div>
            ...
            <div class="flex items-center px-4">
                @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                    <div class="shrink-0 mr-3">
                        <img class="h-10 w-10 rounded-full object-cover" src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->usuario }}" />
                    </div>
                @endif
